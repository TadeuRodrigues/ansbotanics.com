            ...
            <li <?php if ($counter %3 == 0) echo 'class="last"';?>>
              <div class="portfolio-blockimg2">
                ...
                <div class="<?php if ($portfolio_type == "image") echo 'zoom'; else echo 'play';?>">
                  ...
                  <a href="<?php echo ($pf_link) ? $pf_link : thumb_url();?>" rel="prettyPhoto"><img src="<?php echo get_template_directory_uri();?>/timthumb.php?src=<?php echo thumb_url();?>&amp;h=122&amp;w=270&amp;zc=1" class="boximg-pad2 fade" alt="" /></a>
                  <?php } ?>
                </div>
                </div>
