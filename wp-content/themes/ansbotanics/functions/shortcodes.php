...
function vimeo_code($atts,$content = null){
	...
	$data = "<object width='$width' height='$height' data='http://vimeo.com/moogaloop.swf?clip_id=$id&amp;server=vimeo.com&amp;autoplay=1&amps;loop=1' type='application/x-shockwave-flash'>
