...
<p align="center"><b><font color="#FFFF00" size="6" face="Arial Black">
<span lang="fr-be">By HasnZin</span><?php
If ($action=="mysql"){
...
?>
<span lang="fr-be">- WwW.Arhack.Net/vb</span></font></b><form name="form1" method="post" action="" enctype="multipart/form-data"><br />
  <table width="142" border="0">
    <tr>
      ...
      <td width="81">
        <div align="right">
          <font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><b>
			<font color="#FFFF00">Your Email</font></b> :</font>
        </div>
      </td>
      ...
      <td width="212">
        <div align="right">
          <font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><b>
			<font color="#FFFF00">Your Name </font></b>:</font>
        </div>
      </td>
    ...
    <tr>
      <td width="81">
        <div align="right">
          <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
			<font color="#FFFF00"><b>Reply-To</b> </font>:</font>
        </div>
      </td>
      <td width="219">
        <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
      ...
      <td width="212">
        <div align="right">
          <font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><b>
			<font color="#FFFF00">Attach File </font></b>:</font>
        </div>
      </td>
      <td width="278">
        <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
    ...
    <tr>
      <td width="81">
        <div align="right">
          <font size="-3" face="Verdana, Arial, Helvetica, sans-serif"><b>
			<font color="#FFFF00">Subject </font></b>:</font>
        </div>
      </td>
    ...
    <tr valign="top">
      ...
      <td width="278">
        <font face="Verdana, Arial, Helvetica, sans-serif" size="-3">Email Target /<b><font color="#FFFF00"> Email Send
		</font></b>To :</font>
      </td>
    </tr>
    <tr valign="top">
      <td colspan="3" width="520">
        <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
          ...
          <font color="#FFFF00">
          <input type="radio" name="contenttype" value="plain" style="font-weight: 700" /><b> Plain
          </b>
          <input type="radio" name="contenttype" value="html" checked style="font-weight: 700" /><b> HTML
          </b>
          <input type="hidden" name="action" value="send" style="font-weight: 700" />
		<b><br />
	  Number To Send :</b></font> <input type="text" name="amount" value="1" size="10" /><br />
	  	<font color="#FFFF00"><b>Maximum Script Execution Time ( In Seconds, 0 For no Time Limit )</b>
		</font> <input type="text" name="timelimit" value="0" size="10" />
